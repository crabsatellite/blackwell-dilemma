...
and projections back to the current family-core and lower-bound interfaces.
Its non-diagnostic fields and the corresponding gate theorems exclude the
current full-reach, flat-only, all-open-complement, and pointwise-hybrid
diagnostic families; this is the object a final random finite-lattice proof
