...
flat-only, all-open-complement, and pointwise-hybrid diagnostic families; this
is the object a final random finite-lattice proof must instantiate. The topo
payload now also
