...
the derived uniform eventual positive flat-loss witness, an eventual pointwise
positive-loss realisation witness sharing the same lower-bound constant and
size threshold, and projections back to the current family-core and lower-bound
