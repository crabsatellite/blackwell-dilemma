...
horizontal edge, but its giant-restricted topological loss is exactly zero,
which is why it remains only a contract-satisfiability witness rather than the
random-supercritical `Z^2_L` carrier.
