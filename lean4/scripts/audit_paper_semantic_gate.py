...
def main() -> int:
    ...
    print(
        "complete_paper_semantic_kernel_only_current_terminal_kernel_only_nonclosure_open_target_final_ledger_statement_terms_checked=3"
    )
    print(
    ...
    print(
        "complete_paper_semantic_kernel_only_current_terminal_kernel_only_nonclosure_with_open_target_final_ledger_statement_terms_checked=2"
    )
    print(
    ...
    print(
        "complete_paper_semantic_kernel_only_current_terminal_kernel_only_nonclosure_open_target_gate_status_statement_terms_checked=3"
    )
    print(
    ...
    print(
        "complete_paper_semantic_kernel_only_current_terminal_kernel_only_nonclosure_obstruction_map_statement_terms_checked=6"
    )
    print(
