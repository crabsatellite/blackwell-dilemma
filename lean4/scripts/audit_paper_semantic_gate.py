...
def main() -> int:
    ...
    print(
        "complete_paper_semantic_kernel_only_current_open_target_gate_status_statement_terms_checked=8"
    )
    print(
    ...
    print(
        "complete_paper_semantic_kernel_only_current_final_status_statement_terms_checked=10"
    )
    print(
