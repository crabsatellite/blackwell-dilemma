...
def main() -> int:
    ...
    print("complete_paper_semantic_kernel_only_current_open_target_exit_statement_terms_checked=6")
    print(
    ...
    print(
        "complete_paper_semantic_kernel_only_current_open_target_obstruction_exit_statement_terms_checked=6"
    )
    print(
    ...
    print(
        "complete_paper_semantic_kernel_only_current_open_target_route_obstruction_exit_statement_terms_checked=12"
    )
    print(
    ...
    public_manifest_required_lines = [
        ...
        *id_drift_lines("semantic_target_closed_ids", expected_closed_ids, closed_ids),
        ...
        (
            "complete_paper_semantic_kernel_only_current_open_target_exit_statement_terms_checked=6"
        ),
        (
            "complete_paper_semantic_kernel_only_current_open_target_exit_statement_terms_proof="
            "completePaperSemanticKernelOnlyCurrentOpenTargetExitStatements_length_current"
