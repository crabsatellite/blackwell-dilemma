...
| AxiomAudit output (`audit_axiom_output.py`) | dependency lines=4489, no-axiom lines=185, observed axioms=`Classical.choice,Quot.sound,propext`, unexpected=0 | only `propext`, `Classical.choice`, `Quot.sound` |
