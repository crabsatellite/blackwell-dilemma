...
| **Actually-retired §3.4.3 atoms (R186-R201)** | **12** | ALL 12 original §3.4.3 paper-Def atoms RETIRED (no longer `axiom`s in source): R162 (R188), R165 (R187), R166a/b (R195), R167 (R186), R168 (R196), R169 (R197), R170 (R198), R171/R172/R173 (R199), R174+R184 (R200+R201). Each retirement converts the original to a Cat 1 derived `theorem` composing existing infrastructure (R175-R194 modules + Mathlib + Cat 2 axioms) + smaller paper-Def bridge atoms (per discipline §18 atomic-decomposition). The bridge atoms remain as Cat 3 §3.4.3 paper-Def-stipulated structural equations; the welfare/carrier-level claims are all Cat 1 derivedTheorems. |
| **Net atom delta (R186-R201 retirement push)** | **+5 raw bridges, −12 carrier-level axioms** | 14 new smaller bridge atoms added (1 R186 — none new; 1 R187 R184 atom; 1 R188 per-sample; 1 R195 posterior bridge; 1 R196 L-at-betaStar; 2 R197 graph bridges; 1 R198 pointwise; 3 R199 Mills bridges; 2 R200 L_unimodal bridges; 1 R201 corner positivity). Original 12 atoms RETIRED. Net +5 raw bridges, but each is strictly more atomic per discipline §18. **All carrier-level paper-Def atoms are now Cat 1 derived theorems.** |
