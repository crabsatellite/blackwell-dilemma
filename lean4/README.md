...
| paper semantic gate (`audit_paper_semantic_gate.py`) | closed=3, open=2; roster ids/targets/target routes/target-route certificates/target-route obstructions/route-equivalence proofs/closure routes/closure-route certificates/closure-route obstructions/frontier progress certificates/frontier nonclosure certificates/full typed frontier payload certificates/payload-derived route-map/route-closure-progress-nonclosure-frontier projections/cross-surface target/route-map/closure/frontier equality/payload route-map certificate/top-level complete-obstruction certificate and statement roster/closure-input sufficient-route, closure-input named roster and target-to-input obstruction projection, closure-input statement roster, exact-input named roster and target/exact obstruction equivalence, exact-input statement roster, exact-input/output named roster and pairwise obstruction equivalence, output named roster, output statement roster and target/output obstruction equivalence, obstruction-equivalence named roster, obstruction-equivalence statement roster and target/exact/output obstruction rosters, obstruction-equivalence, joint closure-reduction, joint closure statement roster, joint route-obstruction reduction, joint route statement roster, bilateral package obstruction statement roster, Part 6 conditional witness interface and statement roster, Part 6 route-obstruction projection and statement roster, Part 6 field-output statement roster, topo exact-output projection and statement roster, topo route-obstruction projection and statement roster, field, field-obstruction, field statement roster, and output-equivalence certificates/exact-input roster id, target/input, bidirectional projection, iff, sufficient-to-exact, and obstruction consistency/exact-input/output roster id, target/exact/output, bidirectional projection, iff, and obstruction consistency/target-exact-output obstruction-equivalence roster id, current obstructions, and not-iff proofs/joint target/exact/output package equivalences and current package obstructions/joint target/target-route/closure-route package equivalences and current package obstructions/Part 6 conditional witness exact-input and output-bundle projections plus witness obstructions/Part 6 route refutation projections/Part 6 field-output formula roster/topo exact-input and same-bridge-bundle route/output projections plus repair-layer nonclosure boundary/topo route refutation projections/output-equivalence roster id, target/output, bidirectional projection, iff, and obstruction consistency/field-roster id, named closure-input/payload/obstruction/certificate rosters, payload-to-input/iff/not-iff consistency, payload-obstruction, payload-certificate consistency, and field statement formulas/surface-roster consistency/named route-statement roster/named frontier-certificate roster/frontier certificates/all-surface ids/count statement roster and top-level statement roster lengths synced; AxiomAudit prints required=639 | complete paper-semantic closure only after open=0 |
...
pins those target-specific field-output formulas as a Lean `List Prop`.
...
pins the topo target-specific field-output formulas as a Lean `List Prop`.
...
obstruction to sufficient-input obstruction.
...
to named Part 6/topo statements.
`open_semantic_target_exact_closure_input_named_roster_certificate` then pins
the exact closure-input roster to named target/exact/sufficient-input/current
obstruction propositions and proves target obstruction iff exact-input
obstruction for each exact surface.
...
output-bundle obstructions pairwise equivalent on every exact-output surface.
...
obstruction-equivalence formulas to named Part 6/topo statements.
`open_semantic_target_output_equivalence_named_roster_certificate` pins the
target/output roster itself and proves the target/output obstruction
equivalence separately from the exact-input/output surface.
...
target/exact-input/output-bundle obstruction-equivalence roster to named
Part 6/topo target, exact-input, output-bundle, and obstruction propositions.
...
themselves to named Part 6/topo formulas on both surfaces.
...
rosters and proves each field-payload obstruction equivalent to its sufficient
closure-input obstruction.
