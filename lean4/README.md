...
certificate. The kernel-surface and payload-surface views of those three
certificate lists are also definitionally checked equal. The payload surface
also carries payload-derived target-route and closure-route certificate and
obstruction projections for both open targets.
...
both roster counts are synchronized.
