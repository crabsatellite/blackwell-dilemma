...
obstructions, the corresponding current obstruction to the full same-alpha
domination/feasibility/divergence witness for any scaling carrier, an explicit
