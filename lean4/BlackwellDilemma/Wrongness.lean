...
/- Conditional reduction is owned by `UnifiedConditionalReduction.lean`. -/
...
/-- Repaired support-surface entry point for the full topo paper-closing route.

This is the closure spine after repairing the inconsistent old surface: start
from the non-contradictory support-surface repair, add the missing
giant-restricted lower-bound field, and align the flat, giant-restricted,
giant-mass, and in-giant positive-loss outputs on one eventual tail. -/
def RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute
    (bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData) : Prop :=
  RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceRepair bridge /\
    RandomSupercriticalZ2TopoClusterRepairedBridgeGiantLossPaperClosing bridge /\
    Exists fun c : Real =>
...
/-- Full paper-closing support projects to the repaired support-surface closing
route. -/
theorem randomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute_of_full_paper_closing_support
    (bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData)
    (hsupport :
...
/-- The repaired support-surface closing route is sufficient for the original
full paper-closing support surface. -/
theorem randomSupercriticalZ2TopoClusterRepairedBridgeFullPaperClosingSupport_of_support_surface_closing_route
    (bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData)
    (hroute :
      RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute
        bridge) :
    RandomSupercriticalZ2TopoClusterRepairedBridgeFullPaperClosingSupport
      bridge := by
  exact ⟨hroute.1.1, hroute.2.1, hroute.2.2⟩

/-- The repaired support-surface closing route is exactly the full
paper-closing support surface for a fixed repaired bridge. -/
theorem randomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute_iff_full_paper_closing_support
    (bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData) :
    RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute
      bridge ↔
      RandomSupercriticalZ2TopoClusterRepairedBridgeFullPaperClosingSupport
...
/-- The pointwise-on-giant route closes the repaired support-surface spine
before projecting to the older full-support surface. -/
theorem randomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute_of_giant_pointwise_loss_route
    (bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData)
    (hroute :
      RandomSupercriticalZ2TopoClusterRepairedBridgeGiantPointwiseLossRoute
        bridge) :
...
/-- The named full topo paper-closing route is exactly the boxed-torus
finite-`Z2_L` route; the boxed route only adds semantic calibration fields
already available from the same repaired bridge witness. -/
theorem randomSupercriticalZ2TopoClusterFullPaperClosingRoute_iff_boxed_torus_finite_z2L_route :
    RandomSupercriticalZ2TopoClusterFullPaperClosingRoute ↔
      RandomSupercriticalZ2TopoClusterBoxedTorusFiniteZ2LClosingRoute := by
  exact ⟨
...
/-- The repaired support-surface closing route inhabits the named full topo
paper-closing route. -/
theorem randomSupercriticalZ2TopoClusterFullPaperClosingRoute_of_support_surface_closing_route
    (bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData)
    (hroute :
      RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute
        bridge) :
...
/-- The repaired support-surface closing route also exposes the boxed-torus
finite-`Z2_L` calibration layer. -/
theorem randomSupercriticalZ2TopoClusterBoxedTorusFiniteZ2LClosingRoute_of_support_surface_closing_route
    (bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData)
    (hroute :
      RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute
        bridge) :
...
/-- The full topo paper-closing route also exposes the repaired support-surface
repair on the same repaired bridge. -/
theorem randomSupercriticalZ2TopoClusterFullPaperClosingRoute_support_surface_repair_output :
    RandomSupercriticalZ2TopoClusterFullPaperClosingRoute ->
      Exists fun bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData =>
        RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceRepair
          bridge := by
...
/-- The full topo paper-closing route factors through the repaired
support-surface route rather than bypassing that non-contradictory surface. -/
theorem randomSupercriticalZ2TopoClusterFullPaperClosingRoute_support_surface_repair_route :
    RandomSupercriticalZ2TopoClusterFullPaperClosingRoute ->
      RandomSupercriticalZ2TopoClusterSupportSurfaceRepairRoute := by
  intro hroute
  exact
...
/-- Any full topo paper-closing route carries the same support-surface output
as the repaired support-surface route. -/
theorem randomSupercriticalZ2TopoClusterFullPaperClosingRoute_support_surface_repair_output_certificate :
    RandomSupercriticalZ2TopoClusterFullPaperClosingRoute ->
      RandomSupercriticalZ2TopoClusterSupportSurfaceRepairOutput := by
  intro hroute
  exact
...
support, the repaired support-surface repair route/output, giant-loss closing,
the same-tail combined flat/giant/mass/positive support, and arbitrarily large
supported non-diagnostic finite members.  The final two fields package the
numeric output bundle and the paper-support inclusive full output bundle as
...
/-- Compact positive closure-spine certificate for the repaired topo support
surface.

This is the forward route that remains after the inconsistent old support
surface is repaired: the repaired support-surface closing route is equivalent
to the old full-support target, the pointwise-on-giant route feeds that spine,
and any inhabitant then exposes both the named full route and the finite
boxed-torus `Z2_L` calibration layer together with their output certificates. -/
def RandomSupercriticalZ2TopoClusterSupportSurfaceClosingRouteCertificate :
    Prop :=
  (forall bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData,
    RandomSupercriticalZ2TopoClusterRepairedBridgeFullPaperClosingSupport
      bridge ->
...
theorem random_supercritical_z2_topo_cluster_support_surface_closing_route_certificate :
    RandomSupercriticalZ2TopoClusterSupportSurfaceClosingRouteCertificate := by
  exact ⟨
    randomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute_of_full_paper_closing_support,
    randomSupercriticalZ2TopoClusterRepairedBridgeFullPaperClosingSupport_of_support_surface_closing_route,
...
/-- The repaired support-surface closing spine also inherits the current
boxed-torus finite-`Z2_L` route obstruction. -/
theorem
...
/-- Gate certificate that the repaired topo support surface is inhabited but
does not close the current random-supercritical `Z2_L` paper route.

This is the explicit semantic boundary for the current repair layer: the
support-surface route and its output certificate are available, the current
first-edge bridge inhabits the repaired surface, and the named full paper route
and boxed-torus finite `Z2_L` route remain kernel-refuted. -/
def RandomSupercriticalZ2TopoClusterSupportSurfaceRepairNonClosureCertificate :
    Prop :=
  RandomSupercriticalZ2TopoClusterSupportSurfaceRepairRoute /\
    RandomSupercriticalZ2TopoClusterSupportSurfaceRepairRouteOutputCertificate /\
...
theorem random_supercritical_z2_topo_cluster_support_surface_repair_nonclosure_certificate :
    RandomSupercriticalZ2TopoClusterSupportSurfaceRepairNonClosureCertificate := by
  exact ⟨
...
/-- Gate certificate that the repaired support-surface closing spine is not
currently discharged: any inhabitant would expose the boxed-torus finite
`Z2_L` route, while that route remains kernel-refuted. -/
def RandomSupercriticalZ2TopoClusterSupportSurfaceClosingRouteNonClosureCertificate :
    Prop :=
  (forall bridge : RandomSupercriticalZ2TopoClusterRepairedBridgeData,
    RandomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute
        bridge ->
...
theorem random_supercritical_z2_topo_cluster_support_surface_closing_route_nonclosure_certificate :
    RandomSupercriticalZ2TopoClusterSupportSurfaceClosingRouteNonClosureCertificate := by
  exact ⟨
    randomSupercriticalZ2TopoClusterBoxedTorusFiniteZ2LClosingRoute_of_support_surface_closing_route,
    not_randomSupercriticalZ2TopoClusterRepairedBridgeSupportSurfaceClosingRoute,
    not_randomSupercriticalZ2TopoClusterBoxedTorusFiniteZ2LClosingRoute,
...
/-- Source certificate for the current topo route obstruction.

The topo open target is not blocked by an untracked semantic assumption here:
the source is the current support-surface repair route/output, its nonclosure
certificates, the full-route output certificate, the envelope obstruction, and
the first-edge repaired-bridge obstruction at the missing giant-loss field. -/
def RandomSupercriticalZ2TopoClusterRouteObstructionSourceCertificate :
    Prop :=
...
/-- The current topo route-obstruction source is fully kernel-certified. -/
theorem random_supercritical_z2_topo_cluster_route_obstruction_source_certificate :
    RandomSupercriticalZ2TopoClusterRouteObstructionSourceCertificate := by
  exact ⟨
...
/-- Statement roster for the topo route-obstruction source certificate. -/
def randomSupercriticalZ2TopoClusterRouteObstructionSourceStatements :
    List Prop :=
...
/-- Build gate: the topo route-obstruction source roster is fixed. -/
theorem randomSupercriticalZ2TopoClusterRouteObstructionSourceStatements_named_current :
...
/-- Build gate: the topo route-obstruction source roster has thirteen
statements. -/
theorem randomSupercriticalZ2TopoClusterRouteObstructionSourceStatements_length_current :
    randomSupercriticalZ2TopoClusterRouteObstructionSourceStatements.length =
      13 := rfl

/-- Build-gated statement roster certificate for the topo route-obstruction
source package. -/
def RandomSupercriticalZ2TopoClusterRouteObstructionSourceStatementRosterCertificate :
    Prop :=
  randomSupercriticalZ2TopoClusterRouteObstructionSourceStatements =
      [RandomSupercriticalZ2TopoClusterRouteObstructionSourceCertificate,
       RandomSupercriticalZ2TopoClusterCurrentFrontierCertificate,
...
/-- The topo route-obstruction source has a fixed statement roster. -/
theorem random_supercritical_z2_topo_cluster_route_obstruction_source_statement_roster_certificate :
    RandomSupercriticalZ2TopoClusterRouteObstructionSourceStatementRosterCertificate := by
  exact ⟨
