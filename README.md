...
and the companion paper-semantic audit output for the target routes, closure
routes, and AxiomAudit coverage. The public verification command set includes the same Lean
